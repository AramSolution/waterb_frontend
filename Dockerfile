...
# WATER_REWRITE_DESTINATION — next.config.js rewrites·docker-compose·백엔드 context-path와 함께 맞출 것
ARG NEXT_PUBLIC_API_BASE_URL
ARG NEXT_PUBLIC_PAGE_SIZE
ARG WATER_REWRITE_DESTINATION
ENV NEXT_PUBLIC_API_BASE_URL=$NEXT_PUBLIC_API_BASE_URL
ENV NEXT_PUBLIC_PAGE_SIZE=$NEXT_PUBLIC_PAGE_SIZE
ENV WATER_REWRITE_DESTINATION=$WATER_REWRITE_DESTINATION
