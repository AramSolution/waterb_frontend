...
import BizInputGcSection from "@/widgets/userWeb/BizInputGcSection";
import { AuthService } from "@/entities/auth/api";

/**
 * 글로벌 문화탐방(07) 신청 입력 페이지
 * bizInfoGc에서 진입 시 ?proId= 지원사업코드 전달
 */
function BizInputGcPageContent() {
...
export default function BizInputGcPage() {
  return (
    <Suspense fallback={<p className="loading">잠시만 기다려 주세요.</p>}>
      <BizInputGcPageContent />
    </Suspense>
  );
}
