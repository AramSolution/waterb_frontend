...
import { useDrainageEquipPaymentHistory } from "../model/useDrainageEquipPaymentHistory";
import { DrainageEquipPaymentHistorySection } from "./DrainageEquipPaymentHistorySection";
...
export const DrainageEquipPaymentHistoryPageView: React.FC = () => {
  const {
    ...
    noopChange,
  } = useDrainageEquipPaymentHistory();
  ...
  return (
    <>
      ...
      <div className="bg-white rounded-lg shadow">
        ...
        <div className="p-0 fee-payer-register-scope">
          {detailLoading ? (
      ...
      {found ? (
        <DrainageEquipPaymentHistorySection
          itemId={itemId}
