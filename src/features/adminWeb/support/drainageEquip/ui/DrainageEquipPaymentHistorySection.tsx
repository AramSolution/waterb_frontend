...
export interface DrainageEquipPaymentHistorySectionProps {
  itemId?: string;
...
export const DrainageEquipPaymentHistorySection: React.FC<
  DrainageEquipPaymentHistorySectionProps
> = ({
  itemId,
  initialEntries,
  ...
  } = useDrainageEquipPaymentHistorySection(
    initialEntries,
    itemId,
    persistRequestBuilderRef,
    preSaveValidateRef,
  ...
  if (entries.length === 0) {
    return (
      <div className="bg-white rounded-lg shadow mt-6 px-6 py-8 text-sm text-gray-600">
        등록분(배수설비)이 없어 납부내역을 표시할 수 없습니다.
      </div>
    );
  }
  ...
  return (
    <div className="bg-white rounded-lg shadow mt-6 fee-payer-register-scope">
      <div className="px-6 py-4 border-b border-gray-200">
        <h5 className="text-lg font-semibold mb-0">배수설비 납부내역</h5>
      </div>
                ...
                <div className="min-w-0 flex-1 border border-gray-200 md:border-l-0">
                  ...
                  >
                    <div className="w-full">
                      <span className="sr-only">납부 상세 행 추가</span>
