...
/**
 * 꿈틀꿈틀 우리아이 꿈탐험(06) 전용 신청 폼.
 * 보호자 본인인증(인증하기) — 청소년 자기계발 연수지원(bizInput)과 동일.
 * 화면 구성: 학부모정보(관계 포함) → 학생정보 → 학교정보 → 첨부파일.
 * API: BY_STUDENT 로드, POST /api/user/artappm/ (proGb=06).
 */
const BizInputDmSection: React.FC<BizInputDmSectionProps> = ({
  ...
  /** 관계 표시명 (API RELATION_GB_NM 우선, 없으면 relationCd로 포맷) */
